...
urlpatterns = [
    ...
    path('api/schedules/<int:schedule_id>/addCourse/', add_course_to_schedule, name='add_course_to_schedule'),
    path('api/schedules/<int:schedule_id>/deleteCourse/', remove_course_from_schedule,
    ...
    path('api/comments/<int:comment_id>/dislike/', dislike_comment, name='dislike_comment'),
